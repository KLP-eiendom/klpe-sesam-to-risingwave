...
- [ ] [mv-webhook-dedup.md](rules/mv-webhook-dedup.md) — Webhook deduplication and idempotency
...
| 2 | Materialized Views | CRITICAL / HIGH | `mv-` | 4 |
...
- `mv-webhook-dedup` — Deduplicate webhook payloads downstream in Materialized Views
