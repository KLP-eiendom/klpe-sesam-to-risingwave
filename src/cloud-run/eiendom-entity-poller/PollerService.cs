        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            try
            {
                ...
                this.logger.LogInformation(
                    "Starting Eiendom entity poller — {Count} entity type(s) configured",
                    entities.Count);
