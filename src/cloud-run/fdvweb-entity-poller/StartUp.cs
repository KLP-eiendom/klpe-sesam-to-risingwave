    ...
    public class StartUp
    {
        ...
        public static void ConfigureServices(IServiceCollection services)
        {
            ...
            if (Configuration != null)
            {
                ...
                services.Configure<FdvwebApiSettings>(Configuration.GetSection(nameof(FdvwebApiSettings)));
                services.AddSingleton<FdvwebApiSettings>(r => r.GetService<IOptions<FdvwebApiSettings>>().Value);
                services.AddSingleton<IOAuthApiSettings>(r => r.GetRequiredService<FdvwebApiSettings>());
                services.Configure<RisingWaveSettings>(Configuration.GetSection(nameof(RisingWaveSettings)));
            }

            services.AddHttpClient<IOAuthTokenService, BasicAuthOAuthTokenService>();
            services.AddHttpClient<IFdvwebApiClient, FdvwebApiClient>()
