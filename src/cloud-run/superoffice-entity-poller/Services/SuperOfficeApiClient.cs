namespace SuperOfficeEntityPoller.Services
{
    ...
    public class SuperOfficeApiClient : ISuperOfficeApiClient
    {
        private readonly HttpClient httpClient;
        private readonly ILogger<SuperOfficeApiClient> logger;
        private readonly KdiApiSettings settings;
        private readonly IOAuthTokenService oAuthTokenService;

        public SuperOfficeApiClient(
            HttpClient httpClient,
            ILogger<SuperOfficeApiClient> logger,
            IOptions<KdiApiSettings> settings,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var url = $"{this.settings.KdiApiBaseUrl}/kdi/{entity.EntityPath}";
            ...
            foreach (var element in elements)
            {
                ...
                {
                    var id = IdExpressionEvaluator.Evaluate(entity.IdExpression, dict);
