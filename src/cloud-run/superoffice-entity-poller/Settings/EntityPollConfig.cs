namespace SuperOfficeEntityPoller.Settings
{
    ...
    {
        /// <summary>
        /// Gets or sets the API path relative to the KDI base URL, e.g. "superoffice/contact".
        /// The full URL becomes {KdiApiBaseUrl}/kdi/{EntityPath}.
        /// </summary>
        ...
        /// Example: <c>concat(string(ticketCategoryId), "-superoffice-property")</c>
        /// </summary>
