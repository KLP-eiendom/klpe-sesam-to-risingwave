    ...
    public class StartUp
    {
        ...
        public static void ConfigureServices(IServiceCollection services)
        {
            ...
            if (Configuration != null)
            {
                ...
                services.Configure<KdiApiSettings>(Configuration.GetSection(nameof(KdiApiSettings)));
                services.AddSingleton<KdiApiSettings>(r => r.GetService<IOptions<KdiApiSettings>>().Value);
                services.AddSingleton<IOAuthApiSettings>(r => r.GetRequiredService<KdiApiSettings>());
            ...
            services.AddHttpClient<ISuperOfficeApiClient, SuperOfficeApiClient>()
                .AddPolicyHandler(GetRetryPolicy());

            /*
            services.AddHttpClient<IRisingWaveService, RisingWaveService>()
                .AddPolicyHandler(GetRetryPolicy());
            */
