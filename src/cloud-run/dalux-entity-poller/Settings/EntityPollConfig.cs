namespace DaluxEntityPoller.Settings
{
    ...
    {
        /// <summary>
        /// Gets or sets the API path relative to the Dalux API base URL, e.g. "2.0/companies".
        /// </summary>
        ...
        /// Example: <c>companyId</c>.
        /// </summary>
        public string IdExpression { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the number of items requested per page (the API's <c>limit</c> query parameter).
        /// </summary>
